...
//Here take the initial vertex, mark it as visited and then print the vertex data.
//Then take the edgelist and check the edgelist vertex.
//If the vertex is unvisited then again Call the Dfs function.
  
void DFS(struct vertex *src){
...
//Here again repaet the above process.
//But just check whether that tosearch data exist or not in the Graph.

int DFSSearch(struct vertex *src,char data){
